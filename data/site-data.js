...
const leaders = [
  {
    ...
    bio:"Pesquisador Titular da Fundação Oswaldo Cruz. Atua em Biologia Molecular, regulação pós-transcricional da expressão gênica, proteínas de ligação ao RNA e biologia básica de células-tronco.",
    image:""
  },
  {
    ...
    bio:"Desenvolve pesquisas com células-tronco humanas e modelos in vitro voltados ao estudo de doenças genéticas raras.",
    image:""
  },
  {
    ...
    bio:"Investiga células-tronco adultas, secretoma, vesículas extracelulares e estratégias de engenharia de tecidos.",
    image:""
  },
  {
    ...
    bio:"Atua em projetos relacionados à biologia celular, biomateriais e medicina regenerativa.",
    image:""
  },
  {
    ...
    bio:"Desenvolve pesquisas em citotoxicidade, nanotecnologia, métodos alternativos e toxicologia ambiental.",
    image:""
  }
];
...
const team = [
  ...
  {name:"Ana Paula Ressetti Abud", role:"Colaboradora", area:"Citotoxicidade"},
